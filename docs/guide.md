...
s1: fs2.Stream[Nothing,Int] = fs2.Stream$$anon$1@4e80bc30

scala> val s1a = Stream(1,2,3) // variadic
s1a: fs2.Stream[Nothing,Int] = fs2.Stream$$anon$1@2af63140

scala> val s1b = Stream.emits(List(1,2,3)) // accepts any Seq
s1b: fs2.Stream[Nothing,Int] = fs2.Stream$$anon$1@6742181a
```
...
s1c: fs2.Stream[Nothing,Double] = fs2.Stream$$anon$1@222cc4cb

scala> s1c.mapChunks {
     |   case ds : Chunk.Doubles => /* do things unboxed */ ds
     |   case ds => ds.map(_ + 1)
     | }
res8: fs2.Stream[Nothing,Double] = fs2.Stream$$anon$1@773e4b27
```

The `mapChunks` function is another library primitive. It's used to implement `map` and `filter`.

Let's look at some other example streams:

```scala
scala> val s2 = Stream.empty
s2: fs2.Stream[Nothing,Nothing] = fs2.Stream$$anon$1@48974ab9
...
eff: fs2.Stream[fs2.util.Task,Int] = fs2.Stream$$anon$1@14c24648
```
...
```scala
scala> ra.run
res11: fs2.util.Task[Vector[Int]] = fs2.util.Task@287619ac

scala> rb.run
res12: fs2.util.Task[Unit] = fs2.util.Task@587e5e28

scala> rc.run
res13: fs2.util.Task[Int] = fs2.util.Task@4c7241e2
```
...
appendEx1: fs2.Stream[Nothing,Int] = fs2.Stream$$anon$1@6226e3e4

scala> val appendEx2 = Stream(1,2,3) ++ Stream.eval(Task.now(4))
appendEx2: fs2.Stream[fs2.util.Task,Int] = fs2.Stream$$anon$1@27649176
...
err: fs2.Stream[Nothing,Nothing] = fs2.Stream$$anon$1@375c19ff

scala> val err2 = Stream(1,2,3) ++ (throw new Exception("!@#$"))
err2: fs2.Stream[Nothing,Int] = fs2.Stream$$anon$1@591c7a4

scala> val err3 = Stream.eval(Task.delay(throw new Exception("error in effect!!!")))
err3: fs2.Stream[fs2.util.Task,Nothing] = fs2.Stream$$anon$1@4c5890af
```
...
acquire: fs2.util.Task[Unit] = fs2.util.Task@13c64e3

scala> val release = Task.delay { println("decremented: " + count.decrementAndGet); () }
release: fs2.util.Task[Unit] = fs2.util.Task@6be04db1
```
...
s2: fs2.Stream[fs2.Pure,Int] = fs2.Stream$$anon$1@41852604

scala> s2.toList
res28: List[Int] = List(1, 2)

scala> val s3 = Stream.pure(1,2,3,4).pull(Pull_.take(2)) // alternately
s3: fs2.Stream[fs2.Pure,Int] = fs2.Stream$$anon$1@400e88de
...
res30: fs2.Stream[[x]fs2.Pure[x],Int] = fs2.Stream$$anon$1@c5f8a26
```
...
// s: fs2.Stream[fs2.Pure,Int] = fs2.Stream$$anon$1@38018c18
...
// ns: fs2.Stream[Nothing,Int] = fs2.Stream$$anon$1@75073104
...
S: fs2.Strategy = fs2.Strategy$$anon$5@2c0a8792
...
// s: fs2.Stream[fs2.util.Task,String] = fs2.Stream$$anon$1@3763b145
...
// T: fs2.Async[fs2.util.Task] = fs2.util.Instances$$anon$1@698275c1

val s = Stream.eval_(T.suspend { destroyUniverse() }) ++ Stream("...moving on")
// s: fs2.Stream[fs2.util.Task,String] = fs2.Stream$$anon$1@60459cfe
...
res49: fs2.Stream[fs2.util.Task,Any] = fs2.Stream$$anon$1@77b2b04a
```
