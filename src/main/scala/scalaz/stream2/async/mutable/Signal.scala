...
import scalaz.stream2.{Sink, wye, Process}
import scalaz.stream2.async.mutable
import java.util.concurrent.atomic.AtomicReference
import scalaz.stream2.merge.{Junction, JunctionStrategies}
 ...
 */
trait Signal[A] extends scalaz.stream2.async.immutable.Signal[A] {
