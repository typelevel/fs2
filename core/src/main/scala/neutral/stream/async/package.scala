...
import neutral.stream.async.mutable._

package object async {

  /**
   * Creates bounded queue that is bound by supplied max size bound.
   * Please see [[neutral.stream.async.mutable.Queue]] for more details.
  ...
  /**
   * Creates unbounded queue. see [[neutral.stream.async.mutable.Queue]] for more
   */
