...
class ToFuturePropCheckerAsserting[F[_]](toFuture: F ~> Future)(implicit
  ...
  def check1[A](
      ...
      pos: source.Position,
      names: List[String],
      argNames: Option[List[String]] = None
  ): Result =
  ...
  def check3[A, B, C](
    ...
    target.check3(
      (a: A, b: B, c: C) => toFuture(fun(a, b, c)),
      genA,
      genB,
      genC,
      prms,
  ...
  def check4[A, B, C, D](
    ...
    target.check4(
      (a: A, b: B, c: C, d: D) => toFuture(fun(a, b, c, d)),
      genA,
      genB,
      genC,
      genD,
  ...
  def check5[A, B, C, D, E](
    ...
    target.check5(
      (a: A, b: B, c: C, d: D, e: E) => toFuture(fun(a, b, c, d, e)),
      genA,
      genB,
      genC,
      genD,
  ...
  def check6[A, B, C, D, E, G](
    ...
    target.check6(
      (a: A, b: B, c: C, d: D, e: E, g: G) => toFuture(fun(a, b, c, d, e, g)),
      genA,
      genB,
      genC,
      genD,
