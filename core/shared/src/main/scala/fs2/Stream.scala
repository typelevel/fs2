...
final class Stream[+F[_], +O] private[fs2] (private val underlying: Pull[F, O, Unit]) {
  ...
  def evalFilterAsync[F2[x] >: F[
    x
  ]: ConcurrentThrow: Ref.Mk: Deferred.Mk: Semaphore.Mk: SignallingRef.Mk: Queue.Mk](
      maxConcurrent: Int
  ...
  def mapAsync[F2[x] >: F[
    x
  ]: ConcurrentThrow: Ref.Mk: Deferred.Mk: Semaphore.Mk: SignallingRef.Mk: Queue.Mk, O2](
      maxConcurrent: Int
...
object Stream extends StreamLowPriority {
  ...
  implicit final class InvariantOps[F[_], O](private val self: Stream[F, O]) extends AnyVal {
    ...
    /**
      ...
      * }}}
      */
    def observe(p: Pipe[F, O, Unit])(implicit
        F: ConcurrentThrow[F],
        mkRef: Ref.Mk[F],
